...
class SupplierRegistration(TransactionBase):
	def get_feed(self):
	...
	def on_trash(self):
		...
		delete_contact_and_address("Supplier Registration", self.name)
...
def get_supplier_primary_contact(doctype, txt, searchfield, start, page_len, filters):
	...
	return frappe.db.sql(
		...
		WHERE
			...
			and `tabDynamic Link`.link_doctype = 'Supplier Registration'
